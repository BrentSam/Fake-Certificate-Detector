...
def main():
    ...
    try:
        ...
        print("Testing setting ParaTabStops with uno.invoke and uno.Any...")
        try:
            any_val = uno.Any("[]com.sun.star.style.TabStop", (tab,))
            uno.invoke(para, "setPropertyValue", ("ParaTabStops", any_val))
            print("Successfully set ParaTabStops using uno.invoke!")
        except Exception as e:
            print("Failed setting with uno.invoke:")
            traceback.print_exc()
